function generatePoem(event) {
  ...
  let prompt = `please generate an original and uniquely structured poem about ${userInput.value}. display the poem in basic HTML. the poem should be concise and use creative stanza structure and a <br /> where you feel it needs to be. please include an original title, displayed as an <h3>. something you just came up with out of the ether. please also sign the poem at the end with '-bot_POET' inside of a <strong> element. please follow the instructions.`;
